...
- **dir_resize ( nblocks sector16k -- ) - ** Change Directory Size.  
Alter the number of blocks in the directory at location `sector16k` limited to no less than the current number of occupied blocks.  
